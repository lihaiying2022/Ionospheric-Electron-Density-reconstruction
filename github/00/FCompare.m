...
legend('Background','MART0','MART1','Initial')
savefig('./Figs00/New00Voxel.fig')
% title(['MART','交点覆盖率=',num2str(cover_rate)])
save ./Figs00/00NewNe ne_mart0 ne_mart1 ne_background ne_ini
save ./Figs00/00NewData delta ad0 ad1 ad2 rmse0 rmse1 rmse2 Re_Error0 Re_Error1 Re_Error2