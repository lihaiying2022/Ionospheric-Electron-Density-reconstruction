...
legend('Background','MART0','MART1','Initial')
savefig('./Figs06/New06Voxel.fig')
% title(['MART','交点覆盖率=',num2str(cover_rate)])
save ./Figs06/06NewNe ne_mart0 ne_mart1 ne_background ne_ini
save ./Figs06/06NewData delta ad0 ad1 ad2 rmse0 rmse1 rmse2 Re_Error0 Re_Error1 Re_Error2